...
INSERT INTO `attendance` (`AttendanceID`, `StudentID`, `TeacherID`, `Date`, `Status`) VALUES
(1, 34, NULL, '2024-01-02', 'Present');
...
INSERT INTO `student` (`StudentID`, `UserName`, `FirstName`, `LastName`, `Class`, `Password`, `Role`) VALUES
(34, 'Juan', 'Juan', 'Cruz', 'Math', 'pass101', 'Student');
...
(1, 'Teacher', 'Joy', 'V', 'SIA', 'pass123', 'Teacher'),
(2, 'Teacher2', 'Sacha', 'Ville', 'Math', 'pass123', 'Teacher');
...
--
ALTER TABLE `student`
  MODIFY `StudentID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
